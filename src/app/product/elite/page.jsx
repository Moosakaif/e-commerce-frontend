        ...
        <div className='items-center'>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center  bg-opacity-50">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                        ...
                        <div className="mt-4 text-black">
                            ✅ <strong>Elite</strong> has been added to your cart.
                        </div>
            ...
            >
                <div className="container mx-auto">
                    <h3 className="text-4xl font-bold">Elite</h3>
                    <Breadcrumb
                        links={[
                            { href: '/', label: 'Home' },
                            { href: '/products', label: 'Product' },
                            { href: '#', label: 'Elite', active: true },
                        ]}
                    />
                </div>
            </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10">
                            ...
                            <div className="w-full lg:w-1/2 pl-10">
                                <h3 className="text-black text-3xl font-semibold">Elite</h3>
                       ...
                       {/* Prev/Next */}
                        <div className="flex justify-between items-center border-t pt-10">
                            <div className="border-r pr-4">
                                ...
                                <h4>
                                    <Link href="/product/business" className="text-gray-600">
                                        Business
                                    </Link>
                                </h4>
                            </div>
                            <div className="text-right">
                                ...
                                <h4>
                                    <Link href="/product/essential" className="text-gray-600">
                                        Essential
                                    </Link>
                                </h4>
                            </div>
