                ...
                <div className="container mx-auto">
                    ...
                    <Breadcrumb
                        links={[
                            ...
                            { href: '#', label: 'Essential', active: true },
                        ]}
                    />
                </div>
            </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10">
                            ...
                            <div className="w-full lg:w-1/2 pl-10">
                                <h3 className="text-black text-3xl font-semibold">Essential</h3>
                        ...
                        <div className="flex justify-between items-center border-t pt-10">
                            <div className="border-r pr-4">
                                ...
                                <h4>
                                    <Link href="/product/elite" className="text-gray-600">
                                       Elite
                                    </Link>
                                </h4>
                            </div>
                            <div className="text-right">
                                ...
                                <h4>
                                    <Link href="/product/exclusive" className="text-gray-600">
                                        Exclusive
                                    </Link>
                                </h4>
                            </div>
