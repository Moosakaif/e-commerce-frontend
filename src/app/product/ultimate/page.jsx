        ...
        <div className='items-center'>
            ...
            >
                <div className="container mx-auto">
                    <h3 className="text-4xl font-bold">Ultimate</h3>
                    <Breadcrumb
                        links={[
                            { href: '/', label: 'Home' },
                            { href: '/products', label: 'Product' },
                            { href: '#', label: 'Ultimate', active: true },
                        ]}
                    />
                </div>
            </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10">
                            ...
                            <div className="w-full lg:w-1/2 pl-10">
                                <h3 className="text-black text-3xl font-semibold">Ultimate</h3>
                        ...
                        <div className="flex justify-between items-center border-t pt-10">
                            <div className="border-r pr-4">
                                ...
                                <h4>
                                    <Link href="/product/pro" className="text-gray-600">
                                        Pro
                                    </Link>
                                </h4>
                            </div>
