    ...
    <>
      ...
      <div
        ...
        <div className="container mx-auto">
          <div className="text-left">
            <h3 className="text-4xl font-bold mb-2">Truck History Report</h3>
      ...
      <section className="bg-gray-800 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-8">
          <div>
            <h2 className="text-3xl font-semibold mb-4">Truck History Report</h2>
            <p className="mb-4">Below we listed our services we provide:</p>
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-black">
            ...
            <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 text-center transition-all hover:scale-105 duration-300">
              ...
              />
              <h3 className="text-xl font-bold mb-4 text-black">SUPER</h3>
            ...
            <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 text-center transition-all hover:scale-105 duration-300">
              ...
              <h3 className="text-xl font-bold text-center mb-4">FAST TRACK (POPULAR)</h3>
            ...
            <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 text-center transition-all hover:scale-105 duration-300">
              ...
              />
              <h3 className="text-xl font-semibold mb-4 text-black">EXCLUSIVE</h3>
