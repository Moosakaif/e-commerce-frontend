    ...
    const slides = [
        {
            ...
            image:
                'https://autoshistoryrecord.com/wp-content/uploads/2024/07/WhatsApp-Image-2024-07-01-at-7.38.00-PM-1024x1024.jpeg',
        },
        {
            ...
            image:
                'https://autoshistoryrecord.com/wp-content/uploads/2024/07/WhatsApp-Image-2024-07-01-at-7.38.01-PM-1024x1024.jpeg',
        },
    ];
    return (
        <>
          ...
          ">ATV History Report Packages</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-black">
                        ...
                        <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 text-center transition-all hover:scale-105 duration-300">
                            ...
                            />
                            <h3 className="text-xl font-bold mb-4 text-black">SILVER</h3>
                        ...
                        <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 text-center transition-all hover:scale-105 duration-300">
                            ...
                            <h3 className="text-xl font-bold text-center mb-4">ULTIMATE (POPULAR)</h3>
